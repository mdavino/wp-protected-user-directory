 ...
 * @subpackage Wp_Protected_User_Directory/public
 */
 ...
 */
class Wp_Protected_User_Directory_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp-protected-user-directory-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-protected-user-directory-public.js', array( 'jquery' ), $this->version, false );
